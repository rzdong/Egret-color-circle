...
var Suggest = (function (_super) {
    ...
    Suggest.prototype.init = function () {
        ...
        group.addChild(new eui.Label('建议'));
        group.addChild(new eui.Label('建议'));
        group.addChild(new eui.Label('建议'));
        group.addChild(new eui.Label('建议'));
        group.addChild(new eui.Label('建议'));
    ...
    Suggest.prototype.backBegin = function () {
    ...
    Suggest.prototype.backEnd = function (ev) {
